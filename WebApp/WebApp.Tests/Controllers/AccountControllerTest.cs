...
namespace WebApp.Tests.Controllers
{
    ...
    public class AccountControllerTest
    {
        ...
        public void ChangePassword_Post_ReturnsViewIfChangePasswordFails()
        {
            ...
            Assert.AreEqual("The old password is wrong or the new password is not valid.", controller.ModelState[""].Errors[0].ErrorMessage);
        ...
        public void Register_Post_ReturnsViewIfRegistrationFails()
        {
            ...
            ViewResult viewResult = (ViewResult)result;
            Assert.AreEqual(model, viewResult.ViewData.Model);
            Assert.AreEqual("The user name does already exist, please try another user name.", controller.ModelState[""].Errors[0].ErrorMessage);
            Assert.AreEqual(10, viewResult.ViewData["PasswordLength"]);
        }
